...
function init()
	...
	self.shipConfig = root.assetJson("/frackinship/configs/frackinship.config")
	message.setHandler("checkUnlockableShipDisabled", function()
		...
		return {disableUnlockableShips = self.shipConfig.disableUnlockableShips, universeFlags = world.universeFlags()}
	end)
